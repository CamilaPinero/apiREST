...
function limpiarTablas() {
	tHeadUsuarios.innerHTML = "";
	tBodyUsuarios.innerHTML = "";
	tHeadCtaBancaria.innerHTML = "";
	tBodyCtaBancaria.innerHTML = "";
	tHeadCtaUsuario.innerHTML = "";
	tBodyCtaUsuario.innerHTML = "";
}
...
function mostrarTablas() {
	const armarTabla = (datos, tablaHead, tablaBody) => {
		...
		datos.forEach((d) => {
			...
			if (tablaBody) {
				const opciones = document.createElement("th");
				opciones.innerHTML = ``; //agregar botones de editar y borrar, para agregar put y delete
				tr.appendChild(opciones);
	...
	document.querySelector(".nuevo-usuario").addEventListener("click", (e) => {
		document
			...
			.addEventListener("submit", async (e) => {
				...
				const result = await postUsuario(nuevoUsuario);
